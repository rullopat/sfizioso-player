...
private:
    ...
    juce::WebSliderRelay        preloadRelay      { "preloadSize" };
    juce::WebSliderRelay        sqLiveRelay       { "sampleQualityLive" };
    juce::WebSliderRelay        sqFreewheelRelay  { "sampleQualityFreewheel" };
    ...
    std::unique_ptr<juce::WebSliderParameterAttachment>       preloadAttach;
    std::unique_ptr<juce::WebSliderParameterAttachment>       sqLiveAttach;
    std::unique_ptr<juce::WebSliderParameterAttachment>       sqFreewheelAttach;
